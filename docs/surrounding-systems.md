...
- **GBIF** — directly, and via Ecdysis as above. Neither path is automated from Beeline: records reach Ecdysis through each atlas's staff, by hand, and GBIF probably the same (Andony, 2026-09-11).
